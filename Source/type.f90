...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=11,N_WALL_SCALAR_INTEGERS=15,N_WALL_SCALAR_LOGICALS=0

TYPE WALL_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER, DIMENSION(:) :: A_LP_MPUA,AWM_AEROSOL,LP_CPUA,LP_MPUA,VEG_FUELMASS_L,VEG_MOISTMASS_L,VEG_TMP_L
   REAL(EB), POINTER :: DUWDT,EW,Q_LEAK,UVW_GHOST,UW0,V_DEP,VEG_HEIGHT,VEL_ERR_NEW,X,Y,Z
...
TYPE GEOMETRY_TYPE
   CHARACTER(LABEL_LENGTH) :: ID,MATL_ID,DEVC_ID,PROP_ID
...
TYPE DUCT_TYPE
   ...
   REAL(EB) :: AREA,AREA_INITIAL,COIL_Q=0._EB,CP_D,DIAMETER,DP_FAN(2)=0._EB,DX=-1._EB,LENGTH,MASS_FLOW_INITIAL=1.E6_EB,&
               ...
               VOLUME_FLOW_INITIAL=1.E6_EB,LOSS(2)=0._EB,SYSTEM_LOSS=-1._EB
...
TYPE DUCTRUN_TYPE
   INTEGER :: N_DUCTS,N_DUCTNODES,DUCT_INTERP_TYPE_INDEX,N_MATRIX_SYSTEM=-1._EB,N_QFANS=-1,N_FANS

...
REAL(EB) :: DEL_P,VDOT,FAN_P_1,FAN_P_2,DEL_PP
...
SELECT CASE (FA%FAN_TYPE)
   CASE(1) ! Constant flow
      ...
      RETURN
   CASE(2) ! Quadratic
      FAN_P_1 = DU%RHO_D*GRAV*(DUCTNODE(DU%NODE_INDEX(2))%XYZ(3)-DUCTNODE(DU%NODE_INDEX(1))%XYZ(3)) + &
         (DUCTNODE(DU%NODE_INDEX(2))%P - DUCTNODE(DU%NODE_INDEX(1))%P)
      FAN_P_2 = DU%RHO_D*GRAV*(DUCTNODE(DU%NODE_INDEX(2))%XYZ(3)-DUCTNODE(DU%NODE_INDEX(1))%XYZ(3)) + &
         (DUCTNODE(DU%NODE_INDEX(2))%P - DUCTNODE(DU%NODE_INDEX(1))%P) + & 
         0.5*DU%RHO_D*DU%TOTAL_LOSS*(FA%MAX_FLOW/DU%AREA)**2
      ...
      DEL_PP = (FAN_P_1 - FAN_P_1*FA%MAX_PRES**2 + FAN_P_2*FA%MAX_PRES**2) / (FAN_P_2*FA%MAX_PRES - FAN_P_1*FA%MAX_PRES + 1)
      ! print*,FAN_P_1,FAN_P_2,DEL_P,DEL_PP
   CASE(3) ! User input fan curve
...
IF (DU%REVERSE) DEL_P=-DEL_PP
DU%DP_FAN(NEW) = DEL_PP
